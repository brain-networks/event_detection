...
ets_beta, rss_beta ,rssr_beta, idxpeak_beta, etspeaks_beta, mu_beta = event_detection(DATA_file,opj(TEMP,'atlas.nii.gz'),opj(TEMP,'surrogate_'),'_beta')
DATA_file=opj(DIR, "pb06.sub-002ParkMabCm.denoised_no_censor.nii.gz")
# ets_, rss_orig, idxpeak_orig, etspeaks_orig, mu_orig = event_detection(DATA_file,opj(TEMP,'atlas.nii.gz'))
ets_orig_sur, rss_orig_sur, rssr_orig_sur, idxpeak_orig_sur, etspeaks_orig_sur, mu_orig_sur = event_detection(DATA_file,opj(TEMP,'atlas.nii.gz'),opj(TEMP,'surrogate_'))
DATA_file=opj(DIR, "pb06.sub-002ParkMabCm.denoised_no_censor_fitt.nii.gz")
ets_fitt, rss_fitt, rssr_fitt, idxpeak_fitt, etspeaks_fitt, mu_fitt = event_detection(DATA_file,opj(TEMP,'atlas.nii.gz'),opj(TEMP,'surrogate_'))
DATA_file=opj(DIR, "sub-002ParkMabCm_AUC_200.nii.gz")
ets_AUC, rss_AUC, rssr_AUC, idxpeak_AUC, etspeaks_AUC, mu_AUC = event_detection(DATA_file,opj(TEMP,'atlas.nii.gz'),opj(TEMP,'surrogate_AUC_'))
